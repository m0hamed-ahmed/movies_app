...
import 'package:the_movie_db/movies/presentation/screens/movie_details_screen.dart';
    ...
    return BlocBuilder<MoviesBloc, MoviesStates>(
      ...
      builder: (context, state) {
        switch(state.nowPlayingState) {
          case RequestStates.loading: return const SizedBox(
            height: 400,
            child: Center(
              child: CircularProgressIndicator(),
            ),
          );
          case RequestStates.loaded: return FadeIn(
            ...
            child: CarouselSlider(
              ...
              items: state.nowPlayingMovies.map((item) {
                return GestureDetector(
                  ...
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => MovieDetailsScreen(id: item.id)));
                  },
                  child: Stack(
                    children: [
                      ShaderMask(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text('Now Playing'.toUpperCase(), style: const TextStyle(fontSize: 16.0, color: Colors.white)),
                                ],
                              ),
                            ),
                            Padding(
          ...
          case RequestStates.error: return SizedBox(
            height: 400,
            child: Center(
